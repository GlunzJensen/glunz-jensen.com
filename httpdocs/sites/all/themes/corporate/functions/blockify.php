...
function corporate_blockify_logo($variables) {
 ...
 * @ingroup themeable
 */
function corporate_blockify_site_name($variables) {
 ...
 * @ingroup themeable
 */
function corporate_blockify_site_slogan($variables) {
 ...
 */
// remove the  id & title 
function corporate_blockify_page_title($variables) {
 ...
 * @ingroup themeable
 */
function corporate_blockify_breadcrumb($variables) {
...
function corporate_blockify_local_actions($variables) {
 ...
 * @ingroup themeable
 */
function corporate_blockify_feed_icons($variables) {
 ...
 */
 ...
 //removed the clearfix
function corporate_blockify_menu_local_tasks($variables) {
