...
function corporate_menu_tree($variables) {
  if(theme_get_setting('corporate_classes_menu_wrapper')){
...
*/
function corporate_menu_link(array $variables) {
  //clean up the classes

  //  $remove = array('first','last','leaf','collapsed','expanded','expandable');
  $remove = array();
  if(theme_get_setting('corporate_classes_menu_items_firstlast')){
    $remove[] .= "first";
    $remove[] .= "last";
  }
  if(theme_get_setting('corporate_classes_menu_leaf')){
    $remove[] .= "leaf";
  }
  if(theme_get_setting('corporate_classes_menu_collapsed')){
    $remove[] .= "collapsed";
    $remove[] .= "expanded";
    $remove[] .= "expandable";
  }

  if(theme_get_setting('corporate_classes_menu_items_active')){
    $remove[] .= "active-trail";
    $remove[] .= "active";
  }
  ...
  if(theme_get_setting('corporate_classes_menu_items_mlid')){  
  ...
  if(theme_get_setting('corporate_classes_menu_items')){
...
function corporate_pager($variables) {
...
function corporate_views_mini_pager($vars) {
  global $pager_page_array, $pager_total;
...
function corporate_item_list($variables) {
