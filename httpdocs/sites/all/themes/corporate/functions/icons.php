...
*/
function corporate_feed_icon($variables) {
...
function corporate_calendar_ical_icon($vars) {
  $url = $vars['url'];
...
/*file icons*/
function corporate_file_link($variables) {
  $file = $variables['file'];
...
/*
function corporate_file_icon($variables) {
  $file = $variables['file'];
