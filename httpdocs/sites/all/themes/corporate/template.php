...
function corporate_process_html(&$vars) {
  $before = array(
    "/>\s\s+/",
    "/\s\s+</",
    "/>\t+</",
 ...
 function corporate_process_node(&$vars) {
     switch($vars['type']){
         case 'product':
             drupal_add_js(drupal_get_path('theme','corporate').'/js/tabs.js');
             drupal_add_js(drupal_get_path('theme','corporate').'/js/views/view.product.js');
 ...
 function corporate_preprocess_field(&$variables) {
